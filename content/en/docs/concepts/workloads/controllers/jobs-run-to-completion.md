...
{{< note >}}
**Note:** See known issue [#54870](https://github.com/kubernetes/kubernetes/issues/54870) for [Kubernetes < v1.12.0](https://v1-11.docs.kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/#handling-pod-and-container-failures)
{{< /note >}}
